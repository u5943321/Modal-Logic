...
\end{holmath}
\end{prop}
%!!!!!3 This is not a definition, I do not want to talk about tau theory.
...
%!!!!!replace all the subforms by propsyms? or discard the term propsyms?
